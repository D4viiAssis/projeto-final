...
<template>
  <form @submit.prevent="handleLogin" class="w-100">
    ...
    <input v-model="password" type="password" class="form-control mb-3" placeholder="Senha" required>
    ...
    <div class="mt-4 small">
      Não tem uma conta? <router-link to="/cadastro" class="fw-bold text-decoration-none">Cadastre-se</router-link>
    </div>
  </form>
</template>